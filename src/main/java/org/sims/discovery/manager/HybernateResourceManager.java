...
public class HybernateResourceManager implements IResourceManager{
  ...
  public HybernateResourceManager(){
    /*try{
      ...
      ObjectReader reader = mapper.readerFor(Base64Variant.class);
      reader.readValue(new File("./serviceref.json"));
      ...
      mapper.writer(new File("./serviceref.json"), serviceMap);
  ...
  public Single<List<IService>> getOwned(){
    return null;
  }
